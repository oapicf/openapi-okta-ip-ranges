...
defmodule OpenAPIOktaIPRanges.RequestBuilder do
  @moduledoc """
  ...
  defp decode(%Tesla.Env{body: body}, %{}) do
    OpenAPIOktaIPRanges.Deserializer.json_decode(body)
  end

  defp decode(%Tesla.Env{body: body}, module) do
    OpenAPIOktaIPRanges.Deserializer.json_decode(body, module)
  end
end
