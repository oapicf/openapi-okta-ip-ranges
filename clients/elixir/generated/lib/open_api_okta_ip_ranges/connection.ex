...
defmodule OpenAPIOktaIPRanges.Connection do
  @moduledoc """
  Handle Tesla connections for OpenAPIOktaIPRanges.

  Additional middleware can be set in the compile-time or runtime configuration:

      config :tesla, OpenAPIOktaIPRanges.Connection,
        base_url: "https://s3.amazonaws.com/okta-ip-ranges",
        adapter: Tesla.Adapter.Hackney

  The default base URL can also be set as:

      config :open_api_okta_ip_ranges,
        :base_url, "https://s3.amazonaws.com/okta-ip-ranges"
  """
  ...
  @doc """
  Configure a OpenAPIOktaIPRanges client.

  ### Parameters

  - `options`: an optional keyword list of OpenAPIOktaIPRanges.Connection.options.
  ...
  def middleware(options \\ []) do
    base_url =
      Keyword.get(
        options,
        :base_url,
        Application.get_env(:open_api_okta_ip_ranges, :base_url, @default_base_url)
      )
    ...
    user_agent =
      Keyword.get(
        ...
        Keyword.get(
          tesla_options,
          :user_agent,
          "openapi-generator - OpenAPIOktaIPRanges 1.0.0 - elixir"
        )
      )
