...
DefaultApi <- R6::R6Class(
  ...
  public = list(
    ...
    IpRangesJsonGet = function(data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$IpRangesJsonGetWithHttpInfo(data_file = data_file, ..., .parse = .parse)
    ...
    IpRangesJsonGetWithHttpInfo = function(data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
