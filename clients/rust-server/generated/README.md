...
- Build date: 2026-08-16T02:03:12.107610501Z[Etc/UTC]
...
```
cargo run --example openapi_client-client IpRangesJsonGet
```
...
```toml
[dependencies]
openapi_client = { version = "1.1.1-pre.0", default-features = false, features = ["client", "server"] }
```

**For server with callbacks that need HTTPS:**
```toml
[dependencies]
openapi_client = { version = "1.1.1-pre.0", features = ["server", "client-tls"] }
```
...
------------- | ------------- | -------------
[****](docs/default_api.md#) | **GET** /ip_ranges.json | Retrieve Okta IP ranges
