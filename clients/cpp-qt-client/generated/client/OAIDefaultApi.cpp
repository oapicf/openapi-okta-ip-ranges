...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    QUrl("https://s3.amazonaws.com/okta-ip-ranges"),
    "No description provided",
    QMap<QString, OAIServerVariable>()));
    _serverConfigs.insert("ipRangesJsonGet", defaultConf);
    _serverIndices.insert("ipRangesJsonGet", 0);
}
...
void OAIDefaultApi::ipRangesJsonGet() {
    QString fullPath = QString(_serverConfigs["ipRangesJsonGet"][_serverIndices.value("ipRangesJsonGet")].URL()+"/ip_ranges.json");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIDefaultApi::ipRangesJsonGetCallback);
...
void OAIDefaultApi::ipRangesJsonGetCallback(OAIHttpRequestWorker *worker) {
    ...
    QMap<QString, OAI_ip_ranges_json_get_200_response_value> output;
    QString json(worker->response);
    QByteArray array(json.toStdString().c_str());
    QJsonDocument doc = QJsonDocument::fromJson(array);
    QJsonObject obj = doc.object();
    for (QString key : obj.keys()) {
        OAI_ip_ranges_json_get_200_response_value val;
    ...
    if (worker->error_type == QNetworkReply::NoError) {
        Q_EMIT ipRangesJsonGetSignal(output);
        Q_EMIT ipRangesJsonGetSignalFull(worker, output);
    } else {
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        Q_EMIT ipRangesJsonGetSignalE(output, error_type, error_str);
        Q_EMIT ipRangesJsonGetSignalEFull(worker, error_type, error_str);
...
#pragma GCC diagnostic pop
        ...
        Q_EMIT ipRangesJsonGetSignalError(output, error_type, error_str);
        Q_EMIT ipRangesJsonGetSignalErrorFull(worker, error_type, error_str);
    }
}
