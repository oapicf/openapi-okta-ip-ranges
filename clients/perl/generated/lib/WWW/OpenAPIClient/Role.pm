...
has version_info => ( is => 'ro',
                      isa => 'HashRef',
                      default => sub { {
                          app_name => 'OpenAPI Okta IP Ranges',
                          app_version => '1.1.1-pre.0',
...
WWW::OpenAPIClient::Role - a Moose role for the OpenAPI Okta IP Ranges

=head2 OpenAPI Okta IP Ranges version: 1.1.1-pre.0
