...
module OpenAPIOktaIPRanges.Core where
...
-- * OpenAPIOktaIPRangesConfig

-- |
data OpenAPIOktaIPRangesConfig = OpenAPIOktaIPRangesConfig
...
-- | display the config
instance P.Show OpenAPIOktaIPRangesConfig where
  show c =
    T.printf
...
-- | constructs a default OpenAPIOktaIPRangesConfig
--
-- configHost:
--
...
-- configUserAgent:
--
-- @"openapi-okta-ip-ranges/0.1.0.0"@
--
newConfig :: IO OpenAPIOktaIPRangesConfig
newConfig = do
    logCxt <- initLogContext
    return $ OpenAPIOktaIPRangesConfig
        { configHost = "https://s3.amazonaws.com/okta-ip-ranges"
        , configUserAgent = "openapi-okta-ip-ranges/0.1.0.0"
...
addAuthMethod :: AuthMethod auth => OpenAPIOktaIPRangesConfig -> auth -> OpenAPIOktaIPRangesConfig
addAuthMethod config@OpenAPIOktaIPRangesConfig {configAuthMethods = as} a =
  config { configAuthMethods = AnyAuthMethod a : as}

-- | updates the config to use stdout logging
withStdoutLogging :: OpenAPIOktaIPRangesConfig -> IO OpenAPIOktaIPRangesConfig
...
withStderrLogging :: OpenAPIOktaIPRangesConfig -> IO OpenAPIOktaIPRangesConfig
...
withNoLogging :: OpenAPIOktaIPRangesConfig -> OpenAPIOktaIPRangesConfig
withNoLogging p = p { configLogExecWithContext =  runNullLogExec}

-- * OpenAPIOktaIPRangesRequest
...
data OpenAPIOktaIPRangesRequest req contentType res accept = OpenAPIOktaIPRangesRequest
  { rMethod  :: NH.Method   -- ^ Method of OpenAPIOktaIPRangesRequest
  , rUrlPath :: [BCL.ByteString] -- ^ Endpoint of OpenAPIOktaIPRangesRequest
  , rParams   :: Params -- ^ params of OpenAPIOktaIPRangesRequest
  , rAuthTypes :: [P.TypeRep] -- ^ types of auth methods
  }
  deriving (P.Show)

-- | 'rMethod' Lens
rMethodL :: Lens_' (OpenAPIOktaIPRangesRequest req contentType res accept) NH.Method
rMethodL f OpenAPIOktaIPRangesRequest{..} = (\rMethod -> OpenAPIOktaIPRangesRequest { rMethod, ..} ) <$> f rMethod
{-# INLINE rMethodL #-}

-- | 'rUrlPath' Lens
rUrlPathL :: Lens_' (OpenAPIOktaIPRangesRequest req contentType res accept) [BCL.ByteString]
rUrlPathL f OpenAPIOktaIPRangesRequest{..} = (\rUrlPath -> OpenAPIOktaIPRangesRequest { rUrlPath, ..} ) <$> f rUrlPath
{-# INLINE rUrlPathL #-}

-- | 'rParams' Lens
rParamsL :: Lens_' (OpenAPIOktaIPRangesRequest req contentType res accept) Params
rParamsL f OpenAPIOktaIPRangesRequest{..} = (\rParams -> OpenAPIOktaIPRangesRequest { rParams, ..} ) <$> f rParams
{-# INLINE rParamsL #-}

-- | 'rParams' Lens
rAuthTypesL :: Lens_' (OpenAPIOktaIPRangesRequest req contentType res accept) [P.TypeRep]
rAuthTypesL f OpenAPIOktaIPRangesRequest{..} = (\rAuthTypes -> OpenAPIOktaIPRangesRequest { rAuthTypes, ..} ) <$> f rAuthTypes
{-# INLINE rAuthTypesL #-}
...
class HasBodyParam req param where
  setBodyParam :: forall contentType res accept. (Consumes req contentType, MimeRender contentType param) => OpenAPIOktaIPRangesRequest req contentType res accept -> param -> OpenAPIOktaIPRangesRequest req contentType res accept
  setBodyParam req xs =
...
class HasOptionalParam req param where
  ...
  applyOptionalParam :: OpenAPIOktaIPRangesRequest req contentType res accept -> param -> OpenAPIOktaIPRangesRequest req contentType res accept
  applyOptionalParam = (-&-)
  {-# INLINE applyOptionalParam #-}

  -- | infix operator \/ alias for 'addOptionalParam'
  (-&-) :: OpenAPIOktaIPRangesRequest req contentType res accept -> param -> OpenAPIOktaIPRangesRequest req contentType res accept
  (-&-) = applyOptionalParam
  {-# INLINE (-&-) #-}
...
-- ** OpenAPIOktaIPRangesRequest Utils

_mkRequest :: NH.Method -- ^ Method
          -> [BCL.ByteString] -- ^ Endpoint
          -> OpenAPIOktaIPRangesRequest req contentType res accept -- ^ req: Request Type, res: Response Type
_mkRequest m u = OpenAPIOktaIPRangesRequest m u _mkParams []

_mkParams :: Params
_mkParams = Params [] [] ParamBodyNone

setHeader ::
     OpenAPIOktaIPRangesRequest req contentType res accept
  -> [NH.Header]
  -> OpenAPIOktaIPRangesRequest req contentType res accept
...
removeHeader :: OpenAPIOktaIPRangesRequest req contentType res accept -> [NH.HeaderName] -> OpenAPIOktaIPRangesRequest req contentType res accept
...
_setContentTypeHeader :: forall req contentType res accept. MimeType contentType => OpenAPIOktaIPRangesRequest req contentType res accept -> OpenAPIOktaIPRangesRequest req contentType res accept
_setContentTypeHeader req =
    case mimeType (P.Proxy :: P.Proxy contentType) of
        Just m -> req `setHeader` [("content-type", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["content-type"]

_setAcceptHeader :: forall req contentType res accept. MimeType accept => OpenAPIOktaIPRangesRequest req contentType res accept -> OpenAPIOktaIPRangesRequest req contentType res accept
...
addForm :: OpenAPIOktaIPRangesRequest req contentType res accept -> WH.Form -> OpenAPIOktaIPRangesRequest req contentType res accept
addForm req newform =
...
_addMultiFormPart :: OpenAPIOktaIPRangesRequest req contentType res accept -> NH.Part -> OpenAPIOktaIPRangesRequest req contentType res accept
...
_setBodyBS :: OpenAPIOktaIPRangesRequest req contentType res accept -> B.ByteString -> OpenAPIOktaIPRangesRequest req contentType res accept
_setBodyBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyB body)

_setBodyLBS :: OpenAPIOktaIPRangesRequest req contentType res accept -> BL.ByteString -> OpenAPIOktaIPRangesRequest req contentType res accept
_setBodyLBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyBL body)

_hasAuthType :: AuthMethod authMethod => OpenAPIOktaIPRangesRequest req contentType res accept -> P.Proxy authMethod -> OpenAPIOktaIPRangesRequest req contentType res accept
...
class P.Typeable a =>
  ...
  applyAuthMethod
    ...
    -> a
    -> OpenAPIOktaIPRangesRequest req contentType res accept
    -> IO (OpenAPIOktaIPRangesRequest req contentType res accept)
...
_applyAuthMethods
  ...
  -> OpenAPIOktaIPRangesConfig
  -> IO (OpenAPIOktaIPRangesRequest req contentType res accept)
_applyAuthMethods req config@(OpenAPIOktaIPRangesConfig {configAuthMethods = as}) =
  foldlM go req as
  where
