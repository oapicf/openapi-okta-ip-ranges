...
module OpenAPIOktaIPRanges.Client where
...
dispatchLbs
  ...
  -> OpenAPIOktaIPRangesConfig -- ^ config
  -> OpenAPIOktaIPRangesRequest req contentType res accept -- ^ request
