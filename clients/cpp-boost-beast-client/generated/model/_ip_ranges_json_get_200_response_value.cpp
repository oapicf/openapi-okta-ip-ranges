...
_ip_ranges_json_get_200_response_value::_ip_ranges_json_get_200_response_value(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value _ip_ranges_json_get_200_response_value::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void _ip_ranges_json_get_200_response_value::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for _ip_ranges_json_get_200_response_value");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object _ip_ranges_json_get_200_response_value::toJsonObject_internal() const
{
    boost::json::object object;
        if (m_Ip_rangesIsSet) {
            object["ip_ranges"] = JsonValueConverter<std::vector<std::string>>::toJsonValue(getIpRanges());
        }
    return object;
}

void _ip_ranges_json_get_200_response_value::fromJsonObject_internal(boost::json::object const& object)
{
    m_Ip_rangesIsSet = false;
    {
        const auto Ip_rangesIt = object.find("ip_ranges");
        if (Ip_rangesIt != object.end()) {
            setIpRanges(JsonValueConverter<std::vector<std::string>>::fromJsonValue(Ip_rangesIt->value()));
        }
    }
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<_ip_ranges_json_get_200_response_value>>>::toJsonValue(data));
}
...
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<_ip_ranges_json_get_200_response_value>>>::fromJsonValue(boost::json::parse(json));
}
