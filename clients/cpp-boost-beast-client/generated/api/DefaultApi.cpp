...
std::map<std::string, std::shared_ptr<_ip_ranges_json_get_200_response_value>>
DefaultApi::ipRangesJsonGet(
    ) {
    std::string serializedRequestBody;
    std::string path = m_context + "/ip_ranges.json";
    ...
    std::map<std::string, std::shared_ptr<_ip_ranges_json_get_200_response_value>> deserializedResponse = std::map<std::string, std::shared_ptr<_ip_ranges_json_get_200_response_value>>();
    if (statusCode == boost::beast::http::status(200)) {
        ResponseBodyDeserializer<std::map<std::string, std::shared_ptr<_ip_ranges_json_get_200_response_value>>>::deserialize(
