...
------------ | ------------- | ------------- | -------------
*OpenAPIClient.APIs.DefaultApi* | [**IpRangesJsonGet**](DefaultApi.md#iprangesjsonget) | **GET** /ip_ranges.json | Retrieve Okta IP ranges


## Documentation For Models

 - [OpenAPIClient.Models.IpRangesJsonGet200ResponseValue](IpRangesJsonGet200ResponseValue.md)
