...
web::json::value _ip_ranges_json_get_200_response_value::toJson() const
{
    ...
    if(m_Ip_rangesIsSet)
    {
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("ip_ranges"))] = ModelBase::toJson(m_Ip_ranges);
    }
...
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("ip_ranges"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("ip_ranges")));
...
void _ip_ranges_json_get_200_response_value::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Ip_rangesIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("ip_ranges")), m_Ip_ranges));
    }
}
...
bool _ip_ranges_json_get_200_response_value::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("ip_ranges"))))
    {
        std::vector<utility::string_t> refVal_setIpRanges;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("ip_ranges"))), refVal_setIpRanges );
        setIpRanges(refVal_setIpRanges);
    }
    return ok;
}
...
std::vector<utility::string_t> _ip_ranges_json_get_200_response_value::getIpRanges() const
{
    return m_Ip_ranges;
}
