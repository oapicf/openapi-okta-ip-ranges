...
namespace Org.OpenAPITools.Test.Api
{
    ...
    public sealed class DefaultApiTests : ApiTestsBase
    {
        ...
        public async Task IpRangesJsonGetAsyncTest()
        {
            var response = await _instance.IpRangesJsonGetAsync();
            var model = response.Ok();
            Assert.IsType<Dictionary<string, IpRangesJsonGet200ResponseValue>>(model);
        }
    }
}
