...
void OAI_ip_ranges_json_get_200_response_value::fromJsonObject(QJsonObject json) {
    ...
    m_ip_ranges_isValid = ::OpenAPI::fromJsonValue(ip_ranges, json[QString("ip_ranges")]);
...
QJsonObject OAI_ip_ranges_json_get_200_response_value::asJsonObject() const {
    QJsonObject obj;
    if (ip_ranges.size() > 0) {
        obj.insert(QString("ip_ranges"), ::OpenAPI::toJsonValue(ip_ranges));
    }
    return obj;
}
