...
class DefaultApi
{
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array{0: array<string,\OpenAPI\Client\Model\IpRangesJsonGet200ResponseValue>, 1: int, 2: array<string, string[]>} [response data, HTTP status code, HTTP response headers]
     */
