...
class DefaultApi
{
     ...
     */
    public function ipRangesJsonGet(string $contentType = self::contentTypes['ipRangesJsonGet'][0])
    {
     ...
     */
    public function ipRangesJsonGetWithHttpInfo(string $contentType = self::contentTypes['ipRangesJsonGet'][0])
    {
     ...
     */
    public function ipRangesJsonGetAsync(string $contentType = self::contentTypes['ipRangesJsonGet'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ipRangesJsonGetAsyncWithHttpInfo(string $contentType = self::contentTypes['ipRangesJsonGet'][0])
    {
     ...
     */
    public function ipRangesJsonGetRequest(string $contentType = self::contentTypes['ipRangesJsonGet'][0])
    {
