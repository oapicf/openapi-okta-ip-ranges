...
: Url(TEXT("https://s3.amazonaws.com/okta-ip-ranges"))
{
}
...
FHttpRequestPtr OpenAPIDefaultApi::IpRangesJsonGet(const IpRangesJsonGetRequest& Request, const FIpRangesJsonGetDelegate& Delegate /*= FIpRangesJsonGetDelegate()*/) const
{
	if (!IsValid())
		return nullptr;
	...
	HttpRequest->OnProcessRequestComplete().BindRaw(this, &OpenAPIDefaultApi::OnIpRangesJsonGetResponse, Delegate);
	HttpRequest->ProcessRequest();
	return HttpRequest;
}

void OpenAPIDefaultApi::OnIpRangesJsonGetResponse(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FIpRangesJsonGetDelegate Delegate) const
{
	IpRangesJsonGetResponse Response;
