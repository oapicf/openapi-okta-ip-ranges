...
request_params('IpRangesJsonGet') ->
    [
    ];
...
validate_response('IpRangesJsonGet', 200, Body, ValidatorState) ->
    validate_response_body('map', '_ip_ranges_json_get_200_response_value', Body, ValidatorState);
