 ...
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2025-05-10T05:06:23.736667992Z[Etc/UTC]", comments = "Generator version: 7.12.0")
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IpRangesJsonGet200ResponseValue.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IpRangesJsonGet200ResponseValue is not found in the empty JSON string", IpRangesJsonGet200ResponseValue.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IpRangesJsonGet200ResponseValue.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IpRangesJsonGet200ResponseValue` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
