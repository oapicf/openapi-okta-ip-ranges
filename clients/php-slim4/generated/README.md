# php-base - PHP Slim 4 Server library for OpenAPI Okta IP Ranges
...
------------ | ------------- | ------------- | -------------
*AbstractDefaultApi* | **ipRangesJsonGet** | **GET** /ip_ranges.json | Retrieve Okta IP ranges


## Models

* OpenAPIServer\Model\IpRangesJsonGet200ResponseValue
