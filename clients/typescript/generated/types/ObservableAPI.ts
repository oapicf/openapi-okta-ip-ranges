...
export class ObservableDefaultApi {
     ...
     */
    public ipRangesJsonGetWithHttpInfo(_options?: ConfigurationOptions): Observable<HttpInfo<{ [key: string]: IpRangesJsonGet200ResponseValue; }>> {
    ...
    _config = {
      ...
      middleware: allMiddleware || this.configuration.middleware
        ...
        const requestContextPromise = this.requestFactory.ipRangesJsonGet(_config);
        // build promise chain
     ...
     * Retrieve Okta IP ranges
     */
    public ipRangesJsonGet(_options?: ConfigurationOptions): Observable<{ [key: string]: IpRangesJsonGet200ResponseValue; }> {
